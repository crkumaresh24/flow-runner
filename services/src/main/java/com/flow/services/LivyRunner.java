...
import com.flow.services.models.LivyJobResponse;
import com.flow.services.models.Process;
import com.flow.services.models.LivyJobRequest;
...
public class LivyRunner {
    ...
    public long run(Process process) throws URISyntaxException {
        LivyJobRequest livyJobRequest = new LivyJobRequest(TASKS_SERVICES_URL, JARS_SERVICES_URL, PROCESSES_SERVICES_URL, LAKE_S3_BUCKET_NAME, process);
